...
<head>
    ...
    <link href="/cPanel_magic_revision_1595991950/unprotected/cpanel/style_v2_optimized.css" rel="stylesheet" type="text/css" />
...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1454365123/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
...
<input type="hidden" id="goto_uri" value="/3rdparty/phpMyAdmin/phpmyadmin.css.php?nocache=6371077109ltr&amp;server=1" />
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1454365134/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
            ...
            <div id="locale-inner-container">
                ...
                <div id="locale-map">
                    <div class="scroller clear">
                            ...
                            <div class="locale-cell"><a href="?locale=bn">বাংলা</a></div>
                            ...
                            <div class="locale-cell"><a href="?locale=hi">हिन्दी</a></div>
                            ...
                            <div class="locale-cell"><a href="?locale=i_dutch_utf8_cpanelsy_nc">i_dutch_utf8_cpanelsy_nc</a></div>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="/cPanel_magic_revision_1468439117/unprotected/cpanel/images/cpanel-logo.svg" alt="logo" />
        ...
        <!--CLOSE login-container -->
            ...
            <div class="locale-container">
                <noscript>
                    <form method="get" action=".">
                        <select name="locale">
                            ...
                            <option value='en'>English</option><option value='ar'>العربية</option><option value='bg'>български</option><option value='bn'>বাংলা</option><option value='cs'>čeština</option><option value='da'>dansk</option><option value='de'>Deutsch</option><option value='el'>Ελληνικά</option><option value='es'>español</option><option value='es_419'>español latinoamericano</option><option value='es_es'>español de España</option><option value='fi'>suomi</option><option value='fil'>Filipino</option><option value='fr'>français</option><option value='he'>עברית</option><option value='hi'>हिन्दी</option><option value='hu'>magyar</option><option value='i_cpanel_snowmen'>☃ cPanel Snowmen ☃ - i_cpanel_snowmen</option><option value='i_dutch_utf8_cpanelsy_nc'>i_dutch_utf8_cpanelsy_nc</option><option value='id'>Bahasa Indonesia</option><option value='it'>italiano</option><option value='ja'>日本語</option><option value='ko'>한국어</option><option value='ms'>Bahasa Melayu</option><option value='nb'>norsk bokmål</option><option value='nl'>Nederlands</option><option value='no'>Norwegian</option><option value='pl'>polski</option><option value='pt'>português</option><option value='pt_br'>português do Brasil</option><option value='ro'>română</option><option value='ru'>русский</option><option value='sl'>slovenščina</option><option value='sv'>svenska</option><option value='th'>ไทย</option><option value='tr'>Türkçe</option><option value='uk'>українська</option><option value='vi'>Tiếng Việt</option><option value='zh'>中文</option><option value='zh_cn'>中文（中国）</option><option value='zh_tw'>中文（台湾）</option>                        </select>
                ...
                <ul id="locales_list">
                        ...
                        <li><a href="/?locale=bn">বাংলা</a></li>
...
<style>
    ...
    <div class="copyright">Copyright© 2021 cPanel, L.L.C.
