...
[
  ...
  id: '{{index(1)}}',
    ...
    type: 'cat',
    gender: '{{gender()}}',
    eyeColor: '{{random("blue","yellow","green","brown")}}',
    bodyColor: function(tags) {
      var bodyColors = {
        blue:["white", "yellow", "gold"],
        yellow:["white", "blue", "black"],
        green:["white", "black", "gold"],
        brown:["white", "sliver", "black"]
      };
      var chosen_eyeColor = bodyColors[this.eyeColor];
      var chosen_index = tags.integer(0,chosen_eyeColor.length - 1);
      return chosen_eyeColor[chosen_index];
    },
    description:'{{lorem(3,"sentences")}}',
    img:function(tags) {
      return 'https://via.placeholder.com/400/'+ tags.integer(700,999) + '/fff/?text=' + this.username;
